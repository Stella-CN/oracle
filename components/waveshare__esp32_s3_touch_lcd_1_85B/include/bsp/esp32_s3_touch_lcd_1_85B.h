...
/**
 * @file
 * @brief ESP BSP: ESP32-S3-Touch-LCD-1.85B
 */
 ...
 *  @{
 */
#define BSP_BOARD_ESP32_S3_TOUCH_LCD_1_85B 1
/** @} */ // end of boardname
...
/** @defgroup g06_rtc RTC
 *  @brief RTC BSP pins
 *  @{
 */
#define BSP_RTC_INT           (GPIO_NUM_6)
/** @} */ // end of rtc
...
typedef enum {
    BSP_BUTTON_BOOT = 0,
    BSP_BUTTON_MAIN = BSP_BUTTON_BOOT,
    BSP_BUTTON_NUM,
} bsp_button_t;
/** @} */ // end of buttons
 ...
 * LCD interface
 *
 * Board is shipped with 1.85inch ST77916 QSPI display controller.
 * It features 16-bit RGB565 colors, 360x360 resolution and CST816S capacitive touch controller.
 *
